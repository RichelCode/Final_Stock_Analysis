...
macro-financial variables most commonly used to condition equity forecasts, namely an
index level, a policy rate or a yield, are precisely the series whose means move
